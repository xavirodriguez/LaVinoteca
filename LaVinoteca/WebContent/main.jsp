					...
					<h3>Novedades</h3>
					 <c:forEach var="newVino" items="${requestScope.novedades}">
						<article class="row">
							...
							<div class="col-md-3">
								<div><img src="${newVino.imagen}" alt="wine-bottle" height="150" /></div>
                                <div class="botones-enviar-carrito">
                                    <form action="#">
                                       <input type="hidden" value="${topVino.id}" />
                                       <input name="cantidad" size="2" class="spinner" />
                    ...
                    <h3>M&aacute;s vendidos</h3>
                     <c:forEach var="topVino" items="${requestScope.masVendido}">
                        <article class="row">
                            ...
                            <div class="col-md-3">
                                <div><img src="${topVino.imagen}" alt="wine-bottle" height="150" /></div>
